		...
		return async (req: Request, res: Response, next: NextFunction): Promise<void> => {
			try {
				...
				if (error instanceof Error) {
					...
					next({
						status: 500,
						message: "An error occurred while generating an AuthKit URL",
					});
				}
			}
		};
		...
		return async (req: Request, res: Response, next: NextFunction): Promise<void> => {
			try {
				...
				if (error instanceof Error) {
					...
					next({
						status: 500,
						message: "An error occurred while verifying an AuthKit URL",
					});
				}
			}
		};
		...
		return async (req: Request, res: Response, next: NextFunction): Promise<void> => {
			try {
				...
				if (error instanceof Error) {
					...
					next({
						status: 500,
						message: "An error occurred while validating an AuthKit URL",
					});
				}
			}
		};
